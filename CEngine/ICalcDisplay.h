...
public:
    ...
    virtual void SetExpressionDisplay(
        ...
        std::shared_ptr<std::vector<std::shared_ptr<IExpressionCommand>>> const& commands) = 0;
    virtual void SetParenthesisNumber(unsigned int count) = 0;
    ...
    virtual void OnHistoryItemAdded(unsigned int addedItemIndex) = 0;
